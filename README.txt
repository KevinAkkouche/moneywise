...
https://github.com/KevinAkkouche/moneywise
...
└── .gitignore		       # Dossier à ignorer dans l'architecture

ubuntu~			        # Serveur Controleur
├── ansible-moneywise/
│   ├── inventory/
...
Build & tests du backend (Maven via Docker)
Build du frontend (Node/Angular via Docker)
Build des images Docker Compose
Redéploiement de l'application (docker compose down + docker compose up -d)
...
Automatisation			Ansible CI/CD GitHub Actions (self-hosted runner)
